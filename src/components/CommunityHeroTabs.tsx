...
export default function CommunityHeroTabs({
  tabs,
  active,
  onChange,
}: Props) {
    ...
    <motion.div className="mt-10 flex flex-wrap justify-center gap-4">
      {tabs.map((tab) => (
        <button
          ...
          className={`rounded-full px-4 sm:px-6 md:px-8 py-2 sm:py-3 text-xs sm:text-sm font-semibold transition-all duration-300 ${
            active === tab.name
