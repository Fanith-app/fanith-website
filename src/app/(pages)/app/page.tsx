...
export default function SmartRedirect() {
  ...
  return (
    <div className="min-h-screen bg-[#141414] flex items-center justify-start sm:justify-center p-6 pt-28 pb-12">
      <div className="text-center">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#960018] mx-auto"></div>
        <p className="mt-4 text-[#c3c3c3] font-medium">Opening Store...</p>
      </div>
    </div>
  );
}
